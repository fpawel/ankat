...
VALUES
 (0, 'automatic_work', 'delay_blow_nitrogen', 'Длит. продувки N2, мин.', 'integer', 1, 10, 3, 3 ),
 ...
 (4, 'automatic_work', 'timeout_temperature', 'Таймаут установки температуры, минут', 'integer', 5, 270, 120, 120 );
